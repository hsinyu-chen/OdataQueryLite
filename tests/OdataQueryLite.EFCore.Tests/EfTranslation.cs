namespace OdataQueryLite.EFCore.Tests
{
    ...
    /// throw is the modern client-eval signal — the harness uses a real SQL-translating provider (never
    /// the EF InMemory provider, which would client-evaluate everything and hide translation gaps) and surfaces a
